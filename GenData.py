...
def main():
    ...
    imgTrainingNumbers = cv2.resize(imgTrainingNumbers, dsize=(600,450))
    ...
    np.savetxt("D:/DoAn_1/NhanDienBienSoXe/TranningData/classifications.txt", npaClassifications)         #ghi hình ảnh phẳng vào tệp
    
    np.savetxt("D:/DoAn_1/NhanDienBienSoXe/TranningData/flattened_images.txt", npaFlattenedImages)
